...
const INVENTED_EXPERIENCE_PATTERN = /我(?:穿过|买过|亲测|用了(?:一段时间|三个月|很久))/;

export function validateReply({ reply, searchCalled = false, negativeEmotion = false, disallowProductDetails = false, disallowCommerceSuggestions = false }) {
